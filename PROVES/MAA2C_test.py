...
# =====================================================
# User Config: choose between single or multi-episode test
# =====================================================
...
FRAME_DIR = "./frames"
MODEL_EPISODE = 300000  # which checkpoint to load
...
def evaluate_agents(num_episodes=1, save_gif=False):
    ...
    for ep in range(num_episodes):
        ...
        print(f"Episode {ep+1}/{num_episodes} rewards: {total_rewards}")
